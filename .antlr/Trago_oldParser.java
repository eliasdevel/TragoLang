	...
	public final MainContext main() throws RecognitionException {
		...
		try {
			...
			match(OPEN_C);
			                ...
			                prn(".class  public Test");
			             
			                prn(".super  java/lang/Object\n");
			            
			                prn(".method public <init>()V");
			             
			                prn("    aload_0");
			               
			                prn("    invokenonvirtual java/lang/Object/<init>()V");
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case PRINT:
				...
				setState(36);
				match(NL);
				   prn("    invokevirtual java/io/PrintStream/println(I)V\n");
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			while (_la==PLUS || _la==MINUS) {
				...
				setState(43);
				term();
				 prn(((((ExpressionContext)_localctx).op!=null?((ExpressionContext)_localctx).op.getType():0) == PLUS) ? "    iadd" : "    isub"); 
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			while (_la==TIMES || _la==OVER) {
				...
				setState(53);
				factor();
				 prn(((((TermContext)_localctx).op!=null?((TermContext)_localctx).op.getType():0) == TIMES) ? "    imul" : "    idiv"); 
		...
		try {
			...
			case NUM:
				...
				((FactorContext)_localctx).NUM = match(NUM);
				 prn("    ldc " + (((FactorContext)_localctx).NUM!=null?((FactorContext)_localctx).NUM.getText():null));  
				}
				break;
			case OPEN_P:
				enterOuterAlt(_localctx, 2);
